...
public class TopologyBuilder {
    ...
    public TopologyBuilder(boolean isLocal, String topologyClass, String name) {
    ...
    public void setInput(IInput input, int workerCount) {
        ...
        for (int i = 0; i < workerCount; i++) {
            ...
            list.add(inputClone);
            this.inputs.add(inputClone.getClass().getName());
        }
    ...
    public void setOutput(IOutput output, int workerCount) {
        ...
        for (int i = 0; i < workerCount; i++) {
            ...
            this.outputs.add(output.getClass().getName());
        }
        this.workerCount += workerCount;
