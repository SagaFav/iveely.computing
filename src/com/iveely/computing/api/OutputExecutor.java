...
public class OutputExecutor extends IExecutor implements Runnable {
    ...
    public void invoke(Tuple tuple) {
        try {
            ...
            ZookeeperClient.getInstance().setNodeValue("/app/" + this._name + "/finished/" + this._output.getName(), "Exception stopped.");
        }
    }
    ...
    public void end() {
        ...
        ZookeeperClient.getInstance().setNodeValue("/app/" + this._name + "/statistic/output/" + this._output.getName() + "/execute", this._executeCount + "");
        ZookeeperClient.getInstance().setNodeValue("/app/" + this._name + "/finished/" + this._output.getName(), "End.");
    }
}
